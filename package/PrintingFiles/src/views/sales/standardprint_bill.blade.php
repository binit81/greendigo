...
<!--************************************************************Header Section Code********************************************* -->
  <div class="page-header" style="text-align: center">
     <div style="width:100%;float:left;border:0px solid;">
            <span style="font-size:20px;"><center>TAX INVOICE</center></span>
                  ...
                  <div style="width:65% !important;border:0 solid !important;font-size:16px;float:left;">
                      ...
                      <img class="img-fluid invoice-brand-img d-block mb-20 pull-left" src="{{URL::to('/')}}/public/dist/img/rcslogo.png" width="150px" alt="logo" style="margin:0 5px 0 0;border:0px solid;"/>
                  </div>
                  <div style="width:60% !important;border:0px solid !important;font-size:16px;float:left;text-align:left;margin:0 0 0 5px;">
                      <span class="d-block font-weight-600" style="font-size:15px;"><span class="pl-10 text-dark">{{$billingdata->company->company_name}}</span></span><br>
                      <span class="d-block font-weight-600" style="font-size:12px;"><span class="pl-10 text-dark">{{strip_tags($billingdata->company->company_address)}}</span></span><br>
                      <span class="d-block font-weight-600" style="font-size:12px;"><span class="pl-10 text-dark">{{strip_tags ($billingdata->company->company_area)}} {{$billingdata->company->company_city}} - {{$billingdata->company->company_pincode}}</span></span><br>
                      <?php
                      ...
                      {
                      ?>
                       <span class="d-block font-weight-600" style="font-size:12px;"><span class="pl-10 text-dark">({{$company_mobile_code[0]}}){{$billingdata->company->company_mobile}}</span></span><br>
                       <?php
                        }
                       ?>
                        <span class="font-weight-600" style="font-size:12px;"><span class="pl-10 text-dark">{{$billingdata->company->company_email}}</span></span><br>
        ...
        ?>
              <div style="text-align:right !important;width:34% !important;border:0px solid !important;font-size:16px;float:left;">
                  <table>
                      <tr>
                      <td colspan="3" class="font-weight-600" style="font-size:12px;">{{strip_tags ($billingdata->company->website)}}</td>
                           ...
                           && $billingdata['company']['whatsapp_mobile_number']!=NULL)   
                       {
                          ?>
                      <tr>
                      <td class="d-block font-weight-600" style="font-size:12px;"><a class="fa fa-whatsapp"></a></td>
                      <td class="font-weight-600" style="font-size:12px;">&nbsp;:&nbsp;</td>
                      <td class="font-weight-600" style="font-size:12px;">({{$whtapp_mobile_code[0]}}){{$billingdata->company->whatsapp_mobile_number}}</td>
                      </tr>
                      <?php                                            
                     ...
                     if(isset($billingdata) && isset($billingdata['company'])
                           && $billingdata['company']['facebook']!=NULL)   
                       {
                          ?>
                          <tr>
                          <td class="d-block font-weight-600" style="font-size:12px;><a class="fa fa-facebook"></a></td>
                          <td class="font-weight-600" style="font-size:12px;">&nbsp;:&nbsp;</td>
                          <td class="font-weight-600" style="font-size:12px;">{{$billingdata->company->facebook}}</td>
                          </tr><?php
                      ...
                      if(isset($billingdata) && isset($billingdata['company'])
                           && $billingdata['company']['instagram']!=NULL)   
                        {
                          ?>
                        <tr>                                          
                          <td class="d-block font-weight-600" style="font-size:12px;"><a class="fa fa-instagram"></a></td>
                          <td class="font-weight-600" style="font-size:12px;">&nbsp;:&nbsp;</td>
                          <td class="font-weight-600" style="font-size:12px;">{{$billingdata->company->instagram}}</td>                                              
                         </tr>
                         <?php
                       ...
                       if(isset($billingdata) && isset($billingdata['company'])
                           && $billingdata['company']['pinterest']!=NULL)   
                        {
                          ?>
                       <tr>
                          <td class="d-block font-weight-600" style="font-size:12px;"><a class="fa fa-pinterest"></a></td>
                          <td class="font-weight-600" style="font-size:12px;">&nbsp;:&nbsp;</td>
                          <td class="font-weight-600"style="font-size:12px;">{{$billingdata->company->pinterest}}</td>                                             
                      </tr>
                       <?php
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////***********************************************Show discount column if discount is given*****************************************************************************************************///////////////////////////////////////////////////////////////////////////////////////////                                                      
                                                     if($billingdata['overalldiscount']!=0 && $billingdata['overalldiscount']!='' && $billingdata['overalldiscount']!=null)
                                                     {
                                                        ...
                                                        echo $dynamic_header;
                                                      echo  '<th class="text-right text-dark font-12 font-weight-600" style="width:6% !important;'.$billing_calculation_case.'">MRP</th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:10% !important;'.$billing_calculation_case.'">SellingPrice</th>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////***********************************************Hide discount column if discount is not given*****************************************************************************************************///////////////////////////////////////////////////////////////////////////////////////////                                                      
                                                     else
                                                     {
                                                        ...
                                                        <th class="text-dark font-12 font-weight-600  leftAlign" style="width:6% !important;">Barcode</th>';
                                                          echo $dynamic_header;
                                                        echo '<th class="text-right text-dark font-12 font-weight-600" style="width:6% !important;'.$billing_calculation_case.'">MRP</th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:10% !important;'.$billing_calculation_case.'">Rate</th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:4% !important;">Qty</th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:7% !important;'.$billing_calculation_case.'">Taxable Amount</th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:7% !important;'.$billing_calculation_case.'" colspan="2">CGST<br><small>%/Amt.</small></th>
                                                        <th class="text-right text-dark font-12 font-weight-600" style="width:7% !important;'.$billing_calculation_case.'" colspan="2">SGST<br><small>%/Amt.</small></th>
                                                ...
                                                <tr style="border-bottom:1px solid #C0C0C0 !important;font-size:14px !important;">
                                                    ...
                                                    <td class="text-right" style="{{$billing_calculation_case}}">{{round($billingproduct_value->mrp,2)}}</td>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////***********************************************Show discount column if discount is given*****************************************************************************************************///////////////////////////////////////////////////////////////////////////////////////////                                              
                                             if($billingdata['overalldiscount']!=0 && $billingdata['overalldiscount']!='' && $billingdata['overalldiscount']!=null)
                                             {
                                                    ...
                                                    echo '<th class="text-right text-dark font-12 font-weight-600" style="width:6% !important;">MRP</th>
                                                    <th class="text-right text-dark font-12 font-weight-600" style="width:8% !important;">Rate</th>
