                                    ...
                                    <?php 
                                        ...
                                        ?>
                                               ...
                                               <div class="col-md-8">
                                                 <div class="input-group productsearcharea">
                                                    ...
                                                    <input class="form-control form-inputtext typeahead" value="" maxlength="" type="text" name="fastproductsearch" id="fastproductsearch" placeholder="Only Barcode Scanning" data-provide="typeahead" data-items="10" data-source="">&nbsp;&nbsp;
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    {
                                                      ?>
                                                       <select class="form-control form-inputtext invalid" style="" name="store_id" id="store_id">
                                                 ...
                                                 <div class="col-md-2 rightAlign"><h5 class="hk-sec-title showtbalance" style="display:none; margin-right:-30px; margin-top:10px;"><small  class="badge badge-soft-danger ma-0">Outstanding Amount: <b><span class="tcusbalance">0</span></b></small></h5></div>
                                      ...
                                      <?php
                                        ...
                                        else
                                        {
                                             $mainmargin = 6;
                                             $bottommargin = 4;
                                             if($nav_type[0]['po_with_unique_barcode']==1)
                                             {
                                                $mainmargin = 8;
                                                $bottommargin = 2;
                                             }
                                            ...
                                            ?>
                                                <div class="col-md-{{$mainmargin}}">
                                                 <div class="input-group">
                                                     ...
                                                     if($nav_type[0]['po_with_unique_barcode']==1)
                                                     {
                                                        ?><input class="form-control form-inputtext typeahead" value="" maxlength="" type="text" name="fastproductsearch" id="fastproductsearch" placeholder="Only Barcode Scanning" data-provide="typeahead" data-items="10" data-source="">&nbsp;&nbsp;<?php
                                                     }
                                                     ?>
                                                ...
                                                <div class="col-md-{{$bottommargin}} rightAlign"><h5 class="hk-sec-title showtbalance" style="display:none; margin-right:-30px; margin-top:10px;"><small  class="badge badge-soft-danger ma-0">Outstanding Amount: <b><span class="tcusbalance">0</span></b></small></h5></div>
                                            ...
                                            else
                                            {
                                                ...
                                                <div class="col-md-10">
                                                 <div class="input-group productsearcharea">
                                                     <span class="input-group-prepend"><label class="input-group-text searchicon" style="height: 40px;"><i class="fa fa-search"></i></label></span>
                                                    <input class="form-control form-inputtext typeahead" value="" maxlength="" type="text" name="sinvoice_no_search" id="sinvoice_no_search" placeholder="Enter Invoice No." data-provide="typeahead" data-items="10" data-source="">&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-info searchBtn search_inwarddata" style="margin:0 0 20px 0 !important;"><i class="fa fa-search"></i>Search</button>&nbsp;&nbsp;
                                                     <input class="form-control form-inputtext typeahead" value="" maxlength="" type="text" name="productsearch" id="productsearch" placeholder="Enter Barcode/Product Code/Product Name" data-provide="typeahead" data-items="10" data-source="">
                                                ...
                                                <div class="col-md-2">
                                                 ...
                                                 <div class="col-md-2 rightAlign" style="display:none;"><h5 class="hk-sec-title showtbalance" style="display:none; margin-right:-30px; margin-top:10px;"><small  class="badge badge-soft-danger ma-0">Outstanding Amount: <b><span class="tcusbalance">0</span></b></small></h5></div>
                                                 </div>
                                                <?php
                                            }
                                            ?>
