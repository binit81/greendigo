                ...
                <div class="row">
                    <div class="col-md-7 mb-30" style="width:50% !important;border:0px solid !important;font-size:16px;">
                       <input type="hidden" id="rmaxid" value="{{$rmaxsales_id}}">
                              <input type="hidden" id="rminid" value="{{$rminsales_id}}">
                              <input type="hidden" id="rfetchedbillno" value="{{$returnsales[0]['return_bill_id']}}">
  ...
  ?>
                    ...
                    <div class="col-md-5 mb-30" style="width:50% !important;border:0px solid !important;font-size:16px;">
                       ...
                       <table style="float:right;">
                            ...
                            <td class="font-weight-600">&nbsp;:&nbsp;</td>
                            <td class="text-dark font-14 font-weight-600 text-right"><span class="tinvoiceno">{{$returnsales[0]['consign_bill']['bill_no']}}</span></td>
                            </tr>
                            <tr>
...
$(document).ready(function(e){
   ...
   $(".totcount").html('<?php echo count($returnsales)?>');
    ...
    $('.invoiceno').html(<?php echo json_encode($returnsales[0]['consign_bill']['bill_no']);?>);
