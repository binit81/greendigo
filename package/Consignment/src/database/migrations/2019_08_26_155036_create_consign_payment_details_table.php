...
class CreateConsignPaymentDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consign_payment_details', function (Blueprint $table) {
            $table->increments('consign_payment_detail_id');
    ...
    {
        Schema::dropIfExists('consign_payment_details');
    }
}
