...
function getproductdetail(productid)
{
    ...
    callroute(url,type,dataType,data, function (data)
    {
        ...
        if (product_data['Success'] == "True") {
            ...
            if ($.inArray(product_detail['default_qty'], product_detail)>=0)
            {
                product_detail['default_qty'] = product_detail['default_qty'];
            }else{
                product_detail['default_qty'] = 0;
            }
            ...
            if (samerow == 0) {
                ...
                if (product_html == '') {
                    ...
                    product_html +=
                        ...
                        '<td onkeypress = "return testCharacter(event);" class="number editablearea" contenteditable="true" style="color: black;display: none" onkeyup="freeqty(this);" id="free_qty_' + product_id + '">0</td>' +
...
$(document).ready(function ()
{
        ...
        if(edit_inward['inward_product_detail'] != 'undefined' && edit_inward['inward_product_detail'] != '') {
            ...
            $.each(edit_inward['inward_product_detail'], function (productkey, productvalue)
            {
                ...
                product_html +=
                    ...
                    '<td onkeypress = "return testCharacter(event);" class="number editablearea " contenteditable="true" style="color: black;display: none;" onkeyup="freeqty(this);" id="free_qty_' + product_id + '">' + productvalue['free_qty'] + '</td>' +
    ...
    if (edit_stock_inward_data != '' && edit_stock_inward_data != undefined && edit_stock_inward_data != null)
    {
        ...
        if(edit_stock_inward['stock_transfer_detail'] != 'undefined' && edit_stock_inward['stock_transfer_detail'] != '') {
            ...
            {
                var product_html = '';
                if (productvalue['product_data']['hsn_sac_code'] == '' || productvalue['product_data']['hsn_sac_code'] == null) {
                    productvalue['product_data']['hsn_sac_code'] = '';
                }
                if (productvalue['batch_no'] == '' || productvalue['batch_no'] == null) {
                    productvalue['batch_no'] = '';
                }
                ...
                product_html += '<tr id="product_' + product_id + '" data-id="' + productkey + '">' +
                    ...
                    '<td>' + productvalue['product_data']['hsn_sac_code'] + '</td>';
                ...
                product_html +=
                    ...
                    '<td onkeypress = "return testCharacter(event);" class="number editablearea inward_calculation_case" contenteditable="true" style="color: black;" onkeyup="extracharge(this);" id="extra_charge_' + product_id + '">0</td>' +
                    ...
                    '<td style="color: black;" id="pending_qty_' + product_id + '">0</td>' +
                    '</tr>';
                ...
                if (edit_inward['inward_product_detail'] != 'undefined' && edit_inward['inward_product_detail'] != '') {
                    ...
                    $.each(edit_inward['inward_product_detail'], function (productkey, productvalue) {
                        ...
                        if (samerow_edit == 1) {
                            ...
                            product_html +=                                 '<td onkeypress = "return testCharacter(event);" class="number editablearea" contenteditable="true" style="color: black;" onkeyup="baseprice(this);" id="base_price_' + product_id + '">' + productvalue['base_price'] + '</td>' +
